...
// File: contracts/interfaces/IMatrixYard.sol


pragma solidity ^0.8.9;
interface IMatrixYard {
...
contract Matrix is ERC20 {
    ...
    function transferRewardToYard() external ownerOrWallet {
        ...
        ImatrixYard.notifyRewardAmount(_amount);
        previousVaultSupply = totalVaultSupply;
    }
    function addYard(address _yard) external onlyOwner {
        matrixYard = _yard;
        ImatrixYard = IMatrixYard(_yard);
        Ivault.setUpdater(matrixYard);
