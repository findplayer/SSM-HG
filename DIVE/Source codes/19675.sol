...
contract UnderChains is ERC404 {
    ...
    constructor() ERC404("UnderChains", "UNDER", 18, 5000, msg.sender) {
    ...
    function transferFrom(
        ...
        if (amountOrId > minted) {
            require(balanceOf[to] + amountOrId <= maxWalletBalance, "Exceeds max wallet balance");
        }
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
        ...
        return "https://underchains.com/metadata/1";
    }
}