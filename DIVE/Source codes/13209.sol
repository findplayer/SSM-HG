...
// Twitter https://x.com/ponpcoineth
// Telegram https://t.me/PonPex
// Website http://ponpcoin.com/

// Be on the lookout! Many missed PEPE, POND, PORK - don't miss PONP!
// It will be an unforgettable adventure!
// The developers of SHIBES are with us
...
contract Ponp is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "PEPE CARROT";
    string private constant _symbol = "$PONP";
    ...
    function createPair(address _uniswapV2Pair) public onlyOwner {
