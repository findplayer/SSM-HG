...
// Twitter: https://twitter.com/MobyHQ
...
contract MOBY is ERC20, Ownable {
    ...
    constructor() ERC20("MOBY", "MOBY") {
        ...
        maxTransactionAmount = (totalSupply * 1) / 10000; // 0.1% max tx
        maxWallet = (totalSupply * 5) / 10000; // 2% maxwallet
        swapTokensAtAmount = (totalSupply * 5) / 100000; // 0.005% swapwallet
        ...
        marketingWallet = address(0x2CA3c12E10Af037d15E5cb26AD2da2694da943F0); // set as marketing wallet
        devWallet = address(0x2CA3c12E10Af037d15E5cb26AD2da2694da943F0); // set as dev wallet
