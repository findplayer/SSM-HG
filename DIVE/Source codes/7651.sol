...
contract Oozaru is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer{
            ...
            uint256 public numberOfFreeNFTs = 7777;
        ...
        constructor(string memory _initBaseURI) ERC721A("Oozaru", "OOZARU") {
