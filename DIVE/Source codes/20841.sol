...
Email:- wantedeth@protonmail.com
...
contract WANTED is ERC20, Ownable {
    ...
    constructor() ERC20("WANTED", "WTD") {
        ...
        marketingWallet = address(0x8a6CCa97003BF49c41d9CE2DcCD5E549756011A1);
        devWallet = address(0x8a6CCa97003BF49c41d9CE2DcCD5E549756011A1);
    ...
    function updateMaxTxnAmnt(uint256 newMaxBuy, uint256 newMaxSell) external onlyOwner {
    ...
    function updateMaxWalletAmnt(uint256 newPercentage) external onlyOwner {
    ...
    function updateTaxes(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _devFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _devFeeSell) external onlyOwner{
    ...
    function setWallet(address _marketingWallet,address _devWallet) external onlyOwner{
