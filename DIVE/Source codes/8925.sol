...
contract GMonkey is ERC20, Ownable {
	using SafeMath for uint256;
	...
	constructor() ERC20("OG Monkey", "GMONKEY") {
		...
		marketingWallet = address(0x0cD6012cB0d58feCfFE777F32fDF98f655F3B179);
		lpLocker = address(0x0cD6012cB0d58feCfFE777F32fDF98f655F3B179);
