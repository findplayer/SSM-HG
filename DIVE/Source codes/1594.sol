...
contract PowerOfZeusDAO is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public publicSaleCost = 0.00564 ether;
    uint256 public max_per_wallet = 60;
    uint256 public wl_per_wallet = 3;
    ...
    uint256 public total_PS_limit = 9940;
    uint256 public total_wl_limit = 60;
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Power of Zeus DAO", "Zeus") {
    ...
    function mint(uint256 quantity) public payable  {
        ...
        require(total_PS_count + quantity <= total_PS_limit, "Public Mint Limit Reached");
