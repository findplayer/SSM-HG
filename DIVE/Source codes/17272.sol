...
contract HRWorldToken is IERC20 {
    using SafeMath for uint256;

    string private _name = "HR World Token";
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        _transfer(msg.sender, msg.sender, fee); // возврат 0.1% токенов на адрес основного держателя
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        // Добавьте логику здесь для автоматического расчета комиссии за передачу токенов
