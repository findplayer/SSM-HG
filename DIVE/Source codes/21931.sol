...
contract Deelance_PreSale is ReentrancyGuard, Ownable, Pausable {
    ...
    constructor() {
        ...
        dAddress = 0x177b99CE1f0De634155F88372265C4542b72aEe5;
        routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
        USDTtoken = 0xdAC17F958D2ee523a2206206994597C13D831ec7;
        ownertwo = 0x3de72566bA2917D96a90500bd8B165863EE4c900;
        startStep(1);
    }
    ...
    function startStep(uint256 stepIndex) internal {
        ...
        if (stepIndex == 1) {
            ...
            hardcapsizeUSD = 150;
            totalUsdValueForPresale = 150;
            inSaleUSDvalue = 150000000000000000000;
        } else if (stepIndex == 2) {
            salePrice = 27 * (10**15); //0.027 USD
            nextPrice = 30 * (10**15); //0.030 USD
            hardcapsizeUSD = 200;
            totalUsdValueForPresale = 200;
            inSaleUSDvalue = 200000000000000000000;
        } else if (stepIndex == 3){
            salePrice = 30 * (10**15); //0.030 USD
            nextPrice = 30 * (10**15); //0.030 USD
            hardcapsizeUSD = 250;
            totalUsdValueForPresale = 250;
            inSaleUSDvalue = 250000000000000000000;
        } else{
