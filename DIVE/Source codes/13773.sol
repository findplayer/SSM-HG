...
contract TokenVestingPAWZONE is IERC20, Context, ReentrancyGuard {
    ...
    modifier onlyIfBeneficiaryExists(address beneficiary) {
        require(
            ...
            "TokenVestingPAWZONE: INVALID Beneficiary Address! no vesting schedule exists for that beneficiary"
        );
        _;
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(
            owner != address(0),
            "TokenVestingPAWZONE: approve from the zero address"
        );
        require(
            spender != address(0),
            "TokenVestingPAWZONE: approve to the zero address"
        );
    ...
    function transferFrom(
        ...
        require(
            ...
            "TokenVestingPAWZONE: insufficient allowance"
        );
    ...
    function _transfer(address from, address to, uint256 amount) private {
        require(
            from != address(0),
            "TokenVestingPAWZONE: transfer from the zero address"
        );
        require(
            to != address(0),
            "TokenVestingPAWZONE: transfer to the zero address"
        );
        require(
            _balances[from] >= amount,
            "TokenVestingPAWZONE: transfer amount exceeds balance"
        );
    ...
    function getVestingIdAtIndex(
        ...
        require(
            ...
            "TokenVestingPAWZONE: index out of bounds"
        );
        ...
        returns (VestingSchedule memory)
    {
        require(
            ...
            "TokenVestingPAWZONE: INVALID Vesting Schedule Index! no vesting schedule exists at this index for that beneficiary"
        );
    ...
    function getVestingSchedule(
        ...
        require(
            ...
            "TokenVestingPAWZONE: INVALID Vesting Schedule ID! no vesting schedule exists for that id"
        );
    ...
    function createVestingSchedule(
        ...
        require(
            ...
            "TokenVestingPAWZONE: token PAWZONE transferFrom not succeeded"
        );
        _createVestingSchedule(
            _beneficiary,
            _start,
    ...
    function _createVestingSchedule(
        ...
        require(_duration > 0, "TokenVestingPAWZONE: duration must be > 0");
        require(_amount > 0, "TokenVestingPAWZONE: amount must be > 0");
        require(
            _slicePeriodSeconds >= 1,
            "TokenVestingPAWZONE: slicePeriodSeconds must be >= 1"
        );
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "TokenVestingPAWZONE: token PAWZONE rewards transfer to beneficiary not succeeded"
        );
