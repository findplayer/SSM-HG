/*
https://t.me/PepeEntry
https://twitter.com/PepeCoinERC
*/
...
contract PEPE is ERC20, Ownable{
    ...
    uint256 public maxTxAmount = 200_000_000 * 10**9;
    uint256 public maxWalletAmount = 200_000_000 * 10**9;
    ...
    Taxes public taxes = Taxes(20,5,10);
    Taxes public sellTaxes = Taxes(40,10,10);
    uint256 public totalTax = 35;
    uint256 public totalSellTax = 80;
    ...
    constructor(address _devWallet) ERC20("PEPE", unicode"佩佩") {
