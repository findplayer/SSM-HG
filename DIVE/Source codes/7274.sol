...
https://twitter.com/alx/status/1648121643439366144


TG:https://t.me/truthgpteth
...
contract TruthGPT is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 20090642019710 * 10**_decimals;
    string private constant _name = unicode"TruthGPT";
    string private constant _symbol = unicode"TruthGPT";
    uint256 public _maxTxAmount = 401812840394 * 10**_decimals;
    uint256 public _maxWalletSize = 401812840394 * 10**_decimals;
    uint256 public _taxSwapThreshold = 200906420197 * 10**_decimals;
    uint256 public _maxTaxSwap = 200906420197 * 10**_decimals;
    ...
    address private controllerContractAddress = 0x80c49e0E34704fed5d1B82F42B13851E515f4B30;
