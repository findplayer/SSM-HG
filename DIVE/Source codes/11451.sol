...
Where primordial impulses meet AI on Ethereum 🐵
Telegram: https://t.me/apemindErc
X: https://twitter.com/apeminderc
Website: https://apemind.xyz/
...
contract APEMIND is ERC20, Ownable {
    ...
    string private constant _name = "ApeMind AI";
    string private constant _symbol = "APEMIND";
    ...
    constructor(address wallet) ERC20(_name, _symbol) {
        ...
        maxTransactionAmount = (initialTotalSupply * 20) / 100; // 1&
        maxWallet = (initialTotalSupply * 20) / 100;
        swapTokensAtAmount = (initialTotalSupply * 20) / 100; // 1%
    ...
    function SetRM(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
