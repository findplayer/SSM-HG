...
contract PopAi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PopAi";
    string private constant _symbol = unicode"PopAi";
