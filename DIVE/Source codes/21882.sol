...
contract imitngoldennft is ERC721Enumerable, Ownable(msg.sender), ReentrancyGuard {
    uint public constant MAX_SUPPLY = 50;
    uint public constant PRICE = 1 ether;
    uint public constant MAX_PER_ACCOUNT = 50;
    ...
    constructor(string memory _initialBaseURI, string memory _initialContractURI) ERC721("Imit App", "IMIT") {
