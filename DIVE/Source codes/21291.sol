...
contract zkTransfer is ERC20, Ownable {  
    using SafeMath for uint256;
    ...
    constructor() ERC20("zkTransfer", "zkTransfer") { 
        ...
        marketingWallet = address(0x4e6cb86ceDBBd2F9BC4553579761d184c6FfDBf4);
        developmentWallet = address(0x4e6cb86ceDBBd2F9BC4553579761d184c6FfDBf4);
