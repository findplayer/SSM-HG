...
*   ZZZZZZZZ  HH    HH   
*   
*   Auf unsere schoene Vaterstadt Zurich. Sie lebe hoch!
*/
...
contract BoeoeggNFT2023 is ERC721, Ownable, ReentrancyGuard, DefaultOperatorFilterer, IERC2981 {
    using Strings for uint256;

    /// @notice global variables
    uint256 counter = 0;
    string public baseExtension = ".json";
    string public baseURI = "ipfs://bafybeiheea52s3ki2mchz4julrrygddufqgntwqzlirroeu3hu6ack332q/";

    /// @notice prices
    uint256 price = 0.3 ether;

    /// @notice minting finish
    uint256 endblock = 17169234;
    ...
    function checkAdmin() internal view virtual {
        require(admins[msg.sender] || msg.sender == owner(), "Only admins and owner are eligible");
    }
