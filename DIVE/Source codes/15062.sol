//Telegram: https://t.me/Easter_BunnyGirl 
//Twitter: 
//Website: https://bunnygirl.vercel.app/ 
...
contract BUNNYGIRL is ERC20, Ownable {
    ...
    constructor() ERC20("Easter BunnyGirl", "$BUNNYGIRL") {
        ...
        marketingWallet = address(0x58271c4bA5a605E7b7574Cb15000Fcb9d2F69C03); // set as marketing wallet
        developmentWallet = address(0x58271c4bA5a605E7b7574Cb15000Fcb9d2F69C03); // set as development wallet
        treasuryWallet = address(0x58271c4bA5a605E7b7574Cb15000Fcb9d2F69C03); // set a treasury wallet
        operationsWallet = address(0x58271c4bA5a605E7b7574Cb15000Fcb9d2F69C03); // set as operations wallet
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _developmentFee, uint256 _treasuryFee, uint256 _operationsFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellDevelopmentFee + sellTreasuryFee + sellOperationsFee;
        require(sellTotalFees <= 99, "Must keep total sell fees at 99% or less");
    }
