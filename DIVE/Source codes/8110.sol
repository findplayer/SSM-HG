...
contract Capybara is ERC20, Ownable {
    ...
    constructor() ERC20("Capybara", "CAPY") {
		...
		charityWallet = address(0x7333829c28acfA5619642A96F6D0F2F38C3c4B83); // 
        marketingWallet = address(0x7333829c28acfA5619642A96F6D0F2F38C3c4B83); // Weaponery
        devWallet = address(0x4b162dAE5203e2739af5E072135F74f4d0154ab2); // set as dev wallet
