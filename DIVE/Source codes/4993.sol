    ...
    function addWhitelist(address[] memory addressesToAdd , uint256 _amount) external onlyOwner {
        for (uint256 i = 0; i < addressesToAdd.length; i++) {
            if (!whitelist[addressesToAdd[i]]) {
                ...
                Amount[addressesToAdd[i]] = _amount;
