...
contract SamsungAi is ERC20, Ownable {
    ...
    constructor() ERC20("Samsung AI", "BIXBY") {
        ...
        marketingWallet = address(0x245e0Ad63FC4a2Ff874604dED665805A56e8A2e5); // set as marketing wallet
        devWallet = address(0x245e0Ad63FC4a2Ff874604dED665805A56e8A2e5); // set as dev wallet
