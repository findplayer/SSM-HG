...
contract TestCoin is ERC20, Ownable {
    ...
    function setFee(uint256 _developmentFee) public onlyOwner {
        developmentFee = _developmentFee;
        require (developmentFee < 15, "Max Tax limit is 15% ");
    }
    ...
    function swapAndSendToWallets (uint256 tokens) private lockTheSwap {
        ...
        uint256 developmentPart = newBalance.mul(developmentFee).div(developmentFee);
