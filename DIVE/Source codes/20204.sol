//Inspired by all the great work out there from Crypto Legends,powered by ERC-X
...
contract LEGENDSX is ERCX {
    ...
    string private constant _name = "LEGENDS ERCX";
    string private constant _ticker = "LEGENDS ERCX";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            if (seed <= 63) {
                image = "cDK4TP5/VB.jpg";
                color = "Vitalik";
                description = "Legendary NFTs powered by ERC1155, inspired by the visionary Vitalik Buterin, co-founder of Ethereum. These Diamond NFTs are as innovative and multifaceted as Vitalik's contributions to blockchain technology.";
            } else if (seed <= 127) {
                image = "KF8zPJd/cz.jpg";
                color = "CZ";
                description = "Prestigious NFTs powered by ERC1155, celebrating Changpeng Zhao (CZ), the mastermind behind Binance. These Gold NFTs, carefully curated for visionary leaders and crypto enthusiasts";
            } else if (seed <= 191) {
                image = "c1DBqFv/elon.jpg";
                color = "Elon";
                description = "Refined NFTs powered by ERC1155, embodying the dynamic influence of Elon Musk on cryptocurrency. These Silver NFTs reflect Elon's eccentric yet groundbreaking perspectives that have periodically shaped the crypto market's trajectory.";
            } else if (seed <= 255) {
                image = "ZcFKsHd/satoshi.jpg";
                color = "Satoshi";
                description = "In honor of the enigmatic Satoshi Nakamoto, the creator of Bitcoin. These Bronze NFTs are crafted as a tribute to the inception of cryptocurrency, embodying the principles of decentralization and anonymity. Mined by aspiring collectors, they symbolize the foundation upon which the current crypto ecosystem is built, celebrating the mystery and genius of Satoshi's legacy.";
            }

            string memory jsonPreImage = string(abi.encodePacked('{"name": "LEGENDS ERCX #', id.toString(), '","description":"', description, '","external_url":"https://www.bitcoin.com/","image":"', dataURI, image));
