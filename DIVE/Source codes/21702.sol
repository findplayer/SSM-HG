...
contract Friendship is ERC20, Ownable{
    ...
    Taxes public taxes = Taxes(12,10);
    Taxes public sellTaxes = Taxes(35,20);
    uint256 public totalTax = 22;
    ...
    constructor(address _devWallet) ERC20("Friendship Doge", "FRDOGE") {
