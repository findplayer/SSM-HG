...
contract Stabyhoun is ERC20, Ownable{
    ...
    uint256 tsupply = 1e11 * 10 ** decimals();
    ...
    Taxes public taxes = Taxes(23,10);
    Taxes public sellTaxes = Taxes(56,10);
    uint256 public totalTax = 33;
    uint256 public totalSellTax = 66;
    ...
    constructor(address _devWallet) ERC20("Stabyhoun Inu", "Staby") {
    ...
    function setBuyTaxes(uint256 _liquidity, uint256 _dev) external onlyOwner{
        ...
        require(totalTax <= 30, "Must keep fees at 30% or less");
    }
    ...
    function setSellTaxes(uint256 _liquidity, uint256 _dev) external onlyOwner{
        ...
        require(totalSellTax < 100, "Must keep fees at 100% or less");
    }
