...
/// @dev ErcDeAI Transfer Protocol
contract ErcDeAI is Owned {
//   INonfungiblePositionManager public immutable uniswapV3PositionManager;
  ...
  constructor() Owned(msg.sender) {
    ...
    deployer = msg.sender;
    _delete = new DeAI(msg.sender, tokenSupply);
...
contract DeAI is ERC20, Owned {
  constructor(address deployer, uint256 supply) ERC20("DeAI", "DeAI", 18) Owned(msg.sender) {
