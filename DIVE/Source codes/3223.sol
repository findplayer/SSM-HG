...
/**
    ...
    Twitter: https://twitter.com/smurfcat404
...
contract RealSmurfCat404 is ERC404, Pausable, ReEnterGuardians {
    ...
    constructor(
        ...
        uint256 _buylimit,
        uint256 _selllimit
    ) ERC404("Real Smurf Cat 404", "SMURF", 9, 100, _owner) {
        baseTokenURI = "https://g6m23y3yji6ldqn5nh3e7uqzc5yl2jns6z6fm53zc74k4nuedueq.arweave.net/N5mt43hKPLHBvWn2T9IZF3C9JbL2fFZ3eRf4rjaEHQk/";
        balanceOf[msg.sender] = 100 * 10 ** 9;
        buyLimit = _buylimit * 10 ** 9;
        sellLimit = _selllimit * 10 ** 9;
