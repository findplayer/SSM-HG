...
contract NakamigosNouns is ERC721A {
    ...
    constructor() ERC721A("Nakamigos Nouns", "NNS") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeidwrfpjbtuaq76n4azjpdp6tobntqwd2mbo4rwqzbfrfnioxfsrv4/", _toString(tokenId), ".json"));
    }
