...
contract VYM is ERC20, Ownable {
    ...
    constructor() ERC20("VISUAL YIELD MANAGEMENT", "VYM") {
        ...
        maxTransactionAmount = 120000 * 1e18; // 1.2% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x66859B94790428fe083225982680ED6EC0198B27); 
        marketingWallet = address(0x66859B94790428fe083225982680ED6EC0198B27); 
        devWallet = address(0x66859B94790428fe083225982680ED6EC0198B27); 
