...
contract HONGBAO is DN404, Ownable(msg.sender) {
    ...
    function withdrawEther() public onlyOwner {
        ...
        (bool success, ) = taxWallet.call{value: balance}("");
    ...
    */
    function withdrawERC20(address tokenAddress, uint256 amount) public{
        ...
        bool sent = token.transfer(taxWallet, amount);
        require(sent, "Token transfer failed");
    }

        /**
     * @dev Adds an address to the feeExempt.
     * @param _address Address to be added to the feeExempt.
     */
    function addTofeeExempt(address _address) public onlyOwner {
        feeExempt[_address] = true;
    }

    /**
     * @dev Removes an address from the feeExempt.
     * @param _address Address to be removed from the feeExempt.
     */
    function removeFromfeeExempt(address _address) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        // Check if sender or recipient is feeExempted
        if (!feeExempt[sender] && !feeExempt[recipient] && taxRate > 0) {
            ...
            // If either party is feeExempted or tax is 0, transfer as usual
