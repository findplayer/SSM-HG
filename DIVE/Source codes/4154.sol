...
contract GambitLotteryDaily {
    ...
    uint256 public countDownTicker=86400; //1 Days
    ...
    function pickWinner() public restricted {
        ...
        require(reward.balanceOf(address(this)) > 0, "Insufficient Balance");
    ...
    function changeNative(address newNativeAddress) public restricted {
        token = IERC20(newNativeAddress);
    }
}