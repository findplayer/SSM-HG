...
contract Contract is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"DALL·E 3", unicode"DALL·E 3") {
        ...
        // #################################################################
        marketingWallet = address(0x5375CD963703aE5A580f1B93793eAb0DBd322225); // set as marketing wallet
        devWallet = address(0x5375CD963703aE5A580f1B93793eAb0DBd322225); // set as dev wallet
        // #################################################################
        ...
        maxTransactionAmount = (totalSupply * 150) / 1000; // 1% maxtransaction
        maxWallet = (totalSupply * 150) / 1000; // 2% maxwallet
