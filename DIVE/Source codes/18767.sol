...
/*
Shapella inu is Erc-20 memecoins tribute for Etherium first major upgrade Shapella

Telegram : https://t.me/shapellainuofficial
*/
...
contract ShapellaInu is Context, IERC20, Ownable {
    ...
    function changeFee(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) public onlyOwner {
        require(_buyMarketingFee + _buyLiquidityFee < 95 || _sellLiquidityFee + _sellMarketingFee < 95, "Can't change fee higher than 95%");
