...
contract VitalikCEO is ERC20, Ownable {
    ...
    constructor() ERC20("Vitalik CEO", "VitalikCEO") {
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    ...
  	    require(newAmount <= totalSupply() * 1 / 10, "Swap amount cannot be higher than 10% total supply.");
