...
contract TestTheBurn is ERC721A {
    ...
    constructor() ERC721A("Test Burn", "TBDLIVE") {
    ...
    function sendNFTToDead(address nftContractAddress, uint256 tokenId) public {
        ...
        nftContract.safeTransferFrom(msg.sender, DEAD_ADDRESS, tokenId);
    }

    function transferMETL() public {
        // Transfer METL
    ...
    function burnArtifact(uint256 artifactId) public {
