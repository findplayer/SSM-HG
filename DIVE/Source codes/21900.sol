...
// File: Bridge-ENO-Contracts/ReceiverETH.sol
...
contract ReceiverETH is CCIPReceiver {
    mapping(address => bool) private whitelist;
    mapping(address => bool) private isOwner;

    address public unlockContractAddress;
    ...
    constructor(address router, address _unlockContractAddress) CCIPReceiver(router) {
        isOwner[msg.sender] = true;
        unlockContractAddress = _unlockContractAddress;
    }
    ...
    function _ccipReceive(
        ...
        require(whitelist[sender], "Sender not authorized");

        (bool success, ) = unlockContractAddress.call(message.data);
