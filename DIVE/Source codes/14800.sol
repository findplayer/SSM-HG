...
contract X is Context, IERC20, Ownable {
    ...
    address payable public rewardPoolAddress = payable(0x6d7bf223A4328A7f563FC4f273d4C0B94293F104); // reward Pool Address
    address payable public devAddress = payable(0x6b1b081788aBaD737F0c0244841FBEa3bACc42ed); // Dev Address
