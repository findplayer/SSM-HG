...
contract Nodify is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nodify";
    ...
    address payable private _developmentAddress = payable(0x492F27fe295e1C75185A2230C97469D4C34b24dA); 
    address payable private _marketingAddress = payable(0x492F27fe295e1C75185A2230C97469D4C34b24dA);
