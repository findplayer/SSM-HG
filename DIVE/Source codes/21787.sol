...
contract WindForce is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("WindForce", "WindForce") {
        ...
        _fees.sellLiquidityFee = 21;
        _fees.sellDevelopmentFee = 2;
        _fees.sellTotalFees = _fees.sellTreasuryFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;

        treasuryWallet = address(0x2123d986940E4081427aaD06165076d14d2d8941);
        developmentWallet = address(0x0391538D583206e3E176323a018D9CF52df9CE4A);
