...
//TBD is a Frictionless Yield Redistribution Token on the ETHEREUM Chain. Simply hold the token to Gain Automatic Restribution Rewards

//🔥Introducing the birth of  REWARDS WITH $WBTC!! 🔥
//Rewards are all AUTO Distribution
//TELEGRAM :https://t.me/TBDFINANCE
// TWITTER : https://twitter.com/TBDFINANCEWORLD
...
contract TBDFINANCE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BLACK DOLLAR FINANCE";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xc4a5bc1624eaA7a6a273305260D26AC9D841c4c4;
        marketingWallet = 0x5757428Beb4ba84fcb7Dae2cE6828cb4579FE0b0;
        devWallet = 0xbB3f1A08964229e43F1aB2aB0B0B6a88C26F954b;
