...
contract HappyEaster is ERC20, Ownable {
    ...
    constructor() ERC20("Happy Easter", "HAPEAS") {
		...
		charityWallet = address(0x79CC4FD57B11D833590755a065aF434005669503); // 
        marketingWallet = address(0x79CC4FD57B11D833590755a065aF434005669503); // Weaponery
        devWallet = address(0x79CC4FD57B11D833590755a065aF434005669503); // set as dev wallet
