/**
https://twitter.com/elonmusk/status/1646228065071292416/photo/1
yeah
*/
...
contract FederalFunding is Context, IERC20, Ownable {
    ...
    string private constant _name = "Federal Funding"; 
    string private constant _symbol = "$NPR"; 
    ...
    address payable private _developmentWalletAddress = payable(0x87A632857e638838f8C698EFdc38a412EC157346);
    address payable private _marketingWalletAddress = payable(0x890d3646323B907504001caeB828CCb17552bb06);
