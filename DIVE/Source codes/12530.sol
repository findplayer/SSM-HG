// Strong Green Candle Community

// https://t.me/StrongGreenCandleCommunity
// https://twitter.com/SGCC_ERC20
// https://stronggreencandle.community/
...
contract SGCC is Context, IERC20, Ownable {
    ...
    string  private constant _name   = unicode"StrongGreenCandleCommunity";
    string  private constant _symbol = unicode"SGCC";
    uint8   private constant _decimals = 18;
    uint256 private constant _totalSupply = 1_000_000 * 10**_decimals;
    uint256 private constant _countTrigger = (_totalSupply * 8) / 10000; // 0.08%
    uint256 public  constant _taxSwapThreshold = (_totalSupply * 2) / 1000; // 0.2%
    uint256 public  constant _maxTaxSwap = (_totalSupply * 5) / 1000; // 0.5%
    uint256 public _maxTxAmount = 14_000 * 10**_decimals; // 1.4%
    uint256 public _maxWalletSize = 14_000 * 10**_decimals; // 1.4%
