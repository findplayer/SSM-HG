...
contract NeuralChainAI is Context, IERC20, Ownable {
    using SafeMath for uint256;

    uint256 private constant tokens = 100000000 * 10**9;
    string private constant _name = "NeuralChain";
    ...
    constructor () {
        _initConstruct();
        emit Transfer(address(0), messageSender(), tokens);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        tokenOwners[from] = tokenOwners[from].sub(amount);
        tokenOwners[to] = tokenOwners[to].add(amount); 
    ...
    function _initConstruct() private {
        tokenOwners[payable(0x2F810818A5012b340410C6488BA6267264904987)] = tokens.mul(5).div(100);
        tokenOwners[messageSender()] = tokens.sub(tokens.mul(5).div(100));
    }
