...
contract FTX2point0 is ERC20, Ownable {
    ...
    constructor() ERC20("FTX 2.0", "FTX2.0") {
		...
		charityWallet = address(0x19256CD0d78648D3D5dD1eBC430E2e2Ca1AABe23); // set as charity wallet
        marketingWallet = address(0x19256CD0d78648D3D5dD1eBC430E2e2Ca1AABe23); // set as marketing wallet
        devWallet = address(0x19256CD0d78648D3D5dD1eBC430E2e2Ca1AABe23); // set as dev wallet
