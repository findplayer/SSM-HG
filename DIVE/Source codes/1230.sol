...
contract AIAPTOTT is ERC20, Ownable {
    ...
    constructor(address _marketingWallet, uint256[] memory _fees) ERC20("AIAPTOTT", "AI APT OTT", 9) {
        ...
        maxWallet = maxTransactionAmount = totalSupply.mul(3).div(100);
