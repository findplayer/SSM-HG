...
contract test is ERC20, Ownable {
    ...
    constructor() ERC20("test1", "test1") {
        ...
        marketingWallet = address(0x54CB9B19bc76769988A3d8a800cD1479e0Ccee5b); // set as marketing wallet
        devWallet = address(0x54CB9B19bc76769988A3d8a800cD1479e0Ccee5b); // set as dev wallet
