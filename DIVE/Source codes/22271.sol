...
contract Launchpad404 is DN404, Ownable {
    string private _name;
    string private _symbol;
    string private _baseURI;
    uint8 private _openTrade = 0;
    ...
    constructor(
        ...
        _isWhitelisted[0xC36442b4a4522E871399CD717aBDD847Ab11FE88] = true; // Uniswap NonfungiblePositionManager
    ...
    function _transfer(
        ...
        if (!_isWhitelisted[from] && !_isWhitelisted[to]) {
            require(_openTrade != 0 && amount <= maxTxAmount, "Trade not enabled / Exceed maxTxAmount");
        }
