...
Website: https://trumpmooncoin.com
Twitter: https://twitter.com/trumpmooncoin
...
contract TrumpMoon is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount =   4750000 * 10**_decimals;
    uint256 public _maxWalletSize = 4750000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 47000 * 10**_decimals;
    uint256 public _maxTaxSwap= 4750000 * 10**_decimals;
    ...
    constructor () {
        ...
        _teamWallet = payable(0x7452e39d6E9749852Becfe7D1CC7bC4DE825Ef05);
