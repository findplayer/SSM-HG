/*
EDCON (Community Ethereum Development Conference ) is a non-profit annual global Ethereum conference that happens once a year in different countries.
It is mainly committed to serving the Ethereum ecosystem in boosting the communication and interaction of Ethereum communities worldwide.
...
contract EDCON is Context, IERC20, Ownable {
    ...
    string private constant _name = "EDCON"; 
    string private constant _symbol = "EDCON"; 
    ...
    address payable private _developmentWalletAddress = payable(0x8016F62CA1f2a149684d65a5621C5554419Bf0d3);
    address payable private _marketingWalletAddress = payable(0x8016F62CA1f2a149684d65a5621C5554419Bf0d3);
