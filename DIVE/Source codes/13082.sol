...
Twitter: https://twitter.com/BoneMarketErc
*/
...
contract BoneMarketToken is Context, ERC20, Ownable {
    ...
    // Address that include in boneMarket LP list
    mapping(address => bool) private _includeInBoneMarketLpList;
    ...
    string private _name = "BoneMarket";
    string private _symbol = "BONEMARKET";
    ...
    // Minimum boneMarket sell order to trigger buyback
    ...
    constructor () public {
        ...
        _includeInBoneMarketLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInBoneMarketLpList(address _address) public view returns (bool) {
        return _includeInBoneMarketLpList[_address];
    }

    function setIncludeInBoneMarketLpList(address _address, bool _isIncludedOrNot) public onlyOwner {
        ...
        _includeInBoneMarketLpList[_address] = _isIncludedOrNot;
    }
    ...
    function _transfer(
        ...
        && !isIncludedInBoneMarketLpList(from)
        && from != owner()
        ) {
            ...
            if (isIncludedInBoneMarketLpList(to)) {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= MIN_TX_AMOUNT_HARD_CAP, "maxTxAmount have to be greater than 1 boneMarket");
