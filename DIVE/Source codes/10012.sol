...
contract Pomerdoge is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1777777 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Pomerdoge";
    string private constant _symbol = "PMDG";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1777 * 10**18;
