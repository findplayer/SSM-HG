...
contract MummifiedMagnate is ERC721A, Ownable {
    uint256 public mintPrice = 0.00177 ether;
    uint256 public maxMintPerUser = 10;
    uint256 public maxMintSupply = 5000;

    constructor() ERC721A("MummifiedMagnate", "MM") {
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmYQ2qZzsph5BjYnvGwWpXbq47dRQm6MZwBaqbYnjgdzWc/";
    }
