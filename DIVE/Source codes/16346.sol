...
contract Amaru is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Pukupuku"; 
    string private constant _symbol = "AMARU"; 
    ...
    address payable private _developmentWalletAddress = payable(0x91499562De991FC6cAb6C42a23B0e8848582837f);
    address payable private _marketingWalletAddress = payable(0x91499562De991FC6cAb6C42a23B0e8848582837f);
