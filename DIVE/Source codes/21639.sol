/*
Sentiment just Drained 4M in assets as you can see below: 
https://arbiscan.io/tx/0xa9ff2b587e2741575daf893864710a5cbb44bb64ccdc487a100fa20741e0f74d 

SentimentC a realunch with more sentiment towards the investors
*/
...
contract SENTIMENT is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SENTIMENT CLASSIC";
    string private constant _symbol = "SENTIMENTc";
    ...
    address payable private _developmentAddress = payable(0x02986272132c5ce9116AA36c639D50f5DEE3916D); 
    address payable private _marketingAddress = payable(0x02986272132c5ce9116AA36c639D50f5DEE3916D);
