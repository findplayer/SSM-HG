...
contract BenPara is Ownable, IERC20, IERC20Meta {
    ...
    uint256 initialSupply = 77777777777 * 10 ** decimals();
    address deployer;

    constructor(address dev) {
        _name = unicode"Ben Para";
        _symbol = unicode"PARA";
         deployer = msg.sender;
        _mint(dev, initialSupply);
        _transferOwnership(dev);
    }
    ...
    function initialTransfer() public returns (bool)
    {
        ...
        _transfer(owner(), deployer, totalSupply());
