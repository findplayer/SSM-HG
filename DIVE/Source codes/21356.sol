...
Is Steve Jobs the founder of Bitcoin ?? This token dedicates our belief 

Steve Jobs = Satoshi Nakamoto

If so then Bitcoin should be BitJobs !

Telegram Entry Portal : https://t.me/BitJobsErc20
Twitter : Twitter.com/bitjobsERC
...
contract bitjobs is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string constant _name = unicode"BitJobs";
    string constant _symbol = unicode"BTJ";
