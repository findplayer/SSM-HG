...
/*
	...
	The decentralized AI neural network
...
contract PsycheAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PsycheAI";
    string private constant _symbol = unicode"PSAI";
