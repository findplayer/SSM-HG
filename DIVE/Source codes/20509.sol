...
Welcome to Spike where we are going to spike things up a bit!!
https://t.me/SpikesPortal
https://twitter.com/_SpikeETH
...
contract SPIKE is ERC20, Ownable {
        ...
        ERC20("Spike TheTopD", "SPIKE")
    {
        ...
        */
        ...
        _createInitialSupply(tokenOwner, (totalSupply * 49) / 100);
        _createInitialSupply(address(this), (totalSupply * 51) / 100);
    }
