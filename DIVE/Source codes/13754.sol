...
contract PROPAGANDA is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0xFdC860860df3db47fCb815792361864840D5A9d8);
    address payable private _marketingWalletAddress = payable(0xFdC860860df3db47fCb815792361864840D5A9d8);
