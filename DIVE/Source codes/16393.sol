...
contract SMI is ERC20, Ownable {
    ...
    constructor() ERC20("Safemoon Inu", "SMI") {
        ...
        marketingWallet = address(0x7A35cf69b1D3A70969D3f42B23Bd82811e1953fD); // set as marketing wallet
        devWallet = address(0x7A35cf69b1D3A70969D3f42B23Bd82811e1953fD); // set as dev wallet
