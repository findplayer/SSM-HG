...
contract TokenSwap is ERC721Holder, Ownable {
    ...
    function ownsTitan() external view returns (bool) {
    ...
    function legendSwap(uint256 _legendTokenId) external {
        require(this.ownsTitan(), "You do not own a Titan, you naughty degen");
