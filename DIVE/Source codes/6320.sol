...
/*
    Twitter:  https://twitter.com/PixieRealm404
    Telegram: https://t.me/PixieRealm_404
    Website:  https://pixierealm.xyz
*/
...
contract PixieRealm404 is DN404, OwnableRoles {
    ...
    address public WETH;
    address public  iPositionManager;
    ...
    function _construct(address initialOwner) internal {
        ...
        _name = "PixieRealm404";
        _symbol = "PixieRealm404";
        gasBurnFactor = 50_000;
        maxBalanceLimit = 35;

        DN404Mirror mirror = new DN404Mirror(msg.sender);
        ...
        uniswapV3Pair = uniswapV3Factory.createPool(address(this), WETH, 10000);
        _setWhitelisted(uniswapV3Pair, true);
        _setWhitelisted(iPositionManager, true);
