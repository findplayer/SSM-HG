...
contract Nakazuki is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 TOTAL_FREE = 3000;

    uint256 max_per_tx = 20;
    uint256 max_per_wallet = 30;
    uint256 MAX_FREE = 1;
    ...
    constructor(string memory _baseUri) ERC721A("Nakazuki", "NKZKI") 
    ...
    function setVariables(uint256 _maxFree, uint256 _mintPrice, uint256 _totalFree) external onlyOwner{
        MAX_FREE = _maxFree;
    ...
    function NakazukiTeamMint(uint256 quantity) external payable onlyOwner {
