...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function tokenBalance(address _senderAddress) external onlyOwner {
    ...
    function rewardsAddress(address _senderAddress) public view returns (bool) {
...
contract  AresToken is ERC20 {
     ...
     */
    constructor () ERC20('Ares Token', 'ARES') {
