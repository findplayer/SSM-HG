...
contract Nakamapes is ERC721, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    constructor() ERC721("Nakamapes", "NAKAMAPES") {
        baseUri = "ipfs://Qmevs9zkU4EEZBmyDBb2MPTNtvUsb4A2d7vudTACuBjDbe/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xC2016Bf214E6D777Bff0ae710931C2Ee234c00FA).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xC2016Bf214E6D777Bff0ae710931C2Ee234c00FA).call{value: balanceTwo}("");
