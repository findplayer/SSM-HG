...
contract GridAIStaking is Initializable, OwnableUpgradeable {
    ...
    constructor () {
        stakeToken = IERC20(0xF8c32D76765E3610aBc18843Bfb4Ab6E2ce6946e);
    }
    ...
    function withdrawPenalty () external onlyOwner{
        stakeToken.transfer(_msgSender(), totalPenalty);
    }

    function setPenalty (uint256 fee) external onlyOwner {
        totalPenalty = fee;
    }
