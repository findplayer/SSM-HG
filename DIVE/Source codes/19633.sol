...
contract AKITA is Context, IERC20, Ownable {
    ...
    uint256 private constant maxSwap = 9000000000 * 10**_decimals;
    ...
    constructor() {
        ...
        marketingWallet = payable(0xc4B4Ea44ac7866664a0058ca75d9B6220f89254e);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xc4B4Ea44ac7866664a0058ca75d9B6220f89254e] = true;
