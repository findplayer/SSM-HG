...
contract NaytGPU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Nayt GPU Technologies","NAYT") {
        ...
        uint256 totalSupply = 1.5 * 1e8 * 1e18;
        ...
        marketingWallet = 0x4912581471970496EB57BD3E422605156596f569; 
        devWallet = 0x4912581471970496EB57BD3E422605156596f569; 
