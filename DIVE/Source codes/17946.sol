 ...
 */
 contract NVIDIA is ERC20, Ownable {
    // Tokenomics ->
    string private _name = "NVIDIA Corp";
    string private _symbol = "NVDA";
    uint8 private _decimals = 9;
    uint256 private _supply = 700000000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 35;
    uint256 public maxTxAmount = 7000000 * 10**_decimals; 
    uint256 public maxWalletAmount = 7000000 * 10**_decimals; 
    address public marketingWallet = 0x0C48b9Bcb1B1071B85399Bb2861f06a3530ab2FD; 
    // Tokenomics 
    ...
    uint256 private _numTokensSellToAddToLiquidity = 3500000 * 10**_decimals;
