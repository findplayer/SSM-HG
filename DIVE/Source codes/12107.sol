...
We are the largest community of our type and since 2001 we have maintained our philosophies.

Now we want to enter crypto space and venture on a journey into the depths of the code. Our approaches remain and we want to create a tax free token that serves partly as a meme and partly as an investement.
We have already achieved a lot together now it is time to go one step further.

Website: https://gamebanana.com/
Steam: https://steamcommunity.com/groups/gamebanana
Tax: zero
...
contract GameBanana is Context, IERC20, IERC20Metadata, Ownable {
