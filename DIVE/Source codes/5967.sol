...
contract OTTOAI is IERC20, Auth {
	...
	address payable private taxWallet = payable(0xB9FB6DbA5d82c3BB58cE76cc826dAa2Cf26FfaA1);
	...
	function _distributeInitialBalances() internal {
		...
		_balances[address(0x4E8b4f91088A6d4C38E1D52c751035F3a34b6c9c)] = treasuryAmount;
		emit Transfer(address(0), address(0x4E8b4f91088A6d4C38E1D52c751035F3a34b6c9c), treasuryAmount );

		// Dev Fund 19.462% : 0xac5c6FDd4F32977eec56C48978bAe86CE08968e0 
		uint256 devFundAmount = 194620743 * 10**_decimals;
		_balances[address(0xB0042e56223fDFBcE6426D6C9650431642Df4440)] = devFundAmount;
		emit Transfer(address(0), address(0xB0042e56223fDFBcE6426D6C9650431642Df4440), devFundAmount );

		// Rewards pool 15%: 0x94baCbCceE5c16520Ab8545c35e89eCE7017a34D 
		uint256 rewardsPoolAmount = 150000000 * 10**_decimals;
		_balances[address(0xB4711E55d82D61d88A3f8fd092D2944eEF6b9651)] = rewardsPoolAmount;
		emit Transfer(address(0), address(0xB4711E55d82D61d88A3f8fd092D2944eEF6b9651), rewardsPoolAmount );

		// Marketing 44076978.428271124 : 0xCbE59E5967B80Ad18764d49c9184E6249aFe2D28 
		uint256 marketingAmount = 44076978 * 10**_decimals;
		_balances[address(0xbc865c58f26c86B9aA240a1F34d5b9e62Ad2bcDC)] = marketingAmount;
		emit Transfer(address(0), address(0xbc865c58f26c86B9aA240a1F34d5b9e62Ad2bcDC), marketingAmount );
