...
// File: contracts/token/ERC20/Ethereum.sol
...
/**
 * @title Ethereum
 * @dev Implementation of the Ethereum
 */
contract Ethereum is ERC20Decimals, ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover, ServicePayer {
    constructor(
        string memory name_,
        ...
        ServicePayer(feeReceiver_, "Ethereum", signature_, _msgSender())
    {
