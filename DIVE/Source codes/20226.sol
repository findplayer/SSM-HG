...
contract G3NES1S is ERC20, Ownable {
    ...
    constructor() ERC20("G3NES1S LABS", "G3NES1S") {
        ...
        devWallet = 0x42FfaB2D8115f011ce85011EEA6c46e3A594D265;
    ...
    function updateTransferNum(uint256 newNum) external onlyOwner {
        require(newNum >= 1);
        transDigit = newNum;
        updateLimits();
    }

    function updateWalletlimit(uint256 newNum) external onlyOwner {
        require(newNum >= 1);
        walletDigit = newNum;
        updateLimits();
    }

    function updateDelayAmount(uint256 newNum) external onlyOwner{
        delayDigit = newNum;
    }
