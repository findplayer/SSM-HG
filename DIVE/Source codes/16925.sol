...
contract LizziesAntiCryptoArmy is ERC721, Ownable {
  ...
  constructor(string memory _coverURI) ERC721("LizziesAntiCryptoArmy", "LACA") {
    coverURI = _coverURI;
  ...
  function mint(uint amount) public payable {
    ...
    require(minters[msg.sender] <= MAX_PER_WALLET, "MAX_TEN_PER_WALLET");
