...
contract WhatList is ERC721AQueryable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public PRICE;
    uint256 public MAX_SUPPLY;
    uint256 public MAX_MINT_AMOUNT_PER_TX;
    uint256 public MAX_MINT_AMOUNT_PER_ADDRESS;
    ...
    constructor(
        ...
        bool isSaleActive
    ) Ownable(msg.sender) ERC721A("What List", "WL") {
        PRICE = price;
        MAX_SUPPLY = maxSupply;
        BASE_URI = baseUri;
        MAX_MINT_AMOUNT_PER_TX = maxMintPerTx;
        MAX_MINT_AMOUNT_PER_ADDRESS = maxMintPerAddress;
    ...
    {
        require(IS_SALE_ACTIVE, "Mint is not active!");
        ...
        require(_numberMinted(msg.sender) + _mintAmount <= MAX_MINT_AMOUNT_PER_ADDRESS, "Address has minted allocation!");
    ...
    address private constant payoutAddress = 0x883045D1A6d72D580dC0aE7586776e7574F4780a;
