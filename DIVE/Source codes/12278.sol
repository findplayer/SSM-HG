...
contract EmptyStrat is BaseStrategy {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    ...
    function execute(address payable to, uint value, bytes calldata data) external onlyVaultManagers returns (bool, bytes memory)  {
