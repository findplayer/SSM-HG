...
contract Betcoin {
    string public constant name = "Betcoin Ai";  //
    string public constant symbol = "BETCOIN";  //
    ...
    address payable constant owner = payable(address(0x7Eeb3EE429f00C93F6059a8000E8ADDaC7A04FCE)); //
