...
contract StakingContract is ReentrancyGuard { 
    ...
    IERC20  private token = IERC20(address(0x949F131F0C6E29693D2ffAbE4d1e30C3Af450418)); // PST token address
    ...
    function withdrawToken(address withdrawer) external noReentrant onlyOwner() {
        ...
        token.safeTransfer(withdrawer, tokenBalance);
    }
