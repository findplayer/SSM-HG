...
contract TongyiQianwen is Context, IERC20, Ownable {
    ...
    string private _name = "Tongyi Qianwen AI";
    string private _symbol = "TONGYIAI";
    ...
    uint256 public totalBuy = 10;
    uint256 public totalSell = 10;
    ...
    uint256 private _offset = 30;    //transaction count
    uint256 private _initSet = 2;
