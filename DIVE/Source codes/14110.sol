...
contract R0ARToken is ERC20 {
    ...
    constructor() public ERC20("R0AR TOKEN", "R0AR") {
        ...
        marketingWallet = 0x0cD53Da3D6e6e0406cE3b9Ca31b783934E22481c;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        if(
            ...
            payable(address(marketingWallet)).transfer(ethBalance);
        }
    ...
    function updateMarketingWallet(address payable _marketingWallet) public onlyOwner {
        require( _marketingWallet != address(0), "R0AR:: tax fee address is zero" );
