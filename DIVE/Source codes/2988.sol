/**
    ...
    Baby Doge has Fast-Track CG & CMC, Great Marketing
    Campaigns, Massive Future Plans & Great Strategies. 
    
    ✅TG @BabyDoge_EN
    ✅Website TheBabyDoge.com
...
contract BABYDOGE is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xbEF7bC289997d35A86B41C6E460ae85bfe0B4040); // build: 0xbEF7bC289997d35A86B41C6E460ae85bfe0B4040


    IRouter02 public swapRouter;
    string constant private _name = "Baby Doge";
    ...
    function internalSwap(uint256 contractTokenBalance) internal {
        ...
        function changeTax(uint256 buy, uint256 sell) external onlyOwner {
            require(buy <= 15,"Freddy: Not allowed");
            require(sell <= 15,"Freddy: Not allowed");
