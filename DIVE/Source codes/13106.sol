...
// File: contracts\BurstLockerV2.sol

pragma solidity 0.6.12;
pragma experimental ABIEncoderV2;
/*
Burst Locking contract for https://www.convexfinance.com/
Burst locked in this contract will be entitled to voting rights for the Convex Finance platform
...
*/
contract BurstLockerV2 is ReentrancyGuard, Ownable {
    ...
    //token constants
    IERC20 public stakingToken; //Burst

    //rewards
    address[] public rewardTokens;
    mapping(address => Reward) public rewardData;

    // FIXME: Duration that rewards are streamed over
    uint256 public constant rewardsDuration = 7 days;
    // uint256 public constant rewardsDuration = 1 hours;

    // FIXME: Duration of lock/earned penalty period
    uint256 public constant lockDuration = rewardsDuration * 16;
    // uint256 public constant lockDuration = rewardsDuration * 1;
    ...
    constructor(address _stakingToken, address _boostPayment) public Ownable() {
        _name = "Locked Burst Token";
        _symbol = "vlBurst";
        _decimals = 18;
    ...
    function _processExpiredLocks(address _account, bool _relock, uint256 _spendRatio, address _withdrawTo, address _rewardAddress, uint256 _checkDelay) internal updateReward(_account) {
        ...
        if (reward > 0) {
            ...
            //transfer reward
            _transferStakingToken(_rewardAddress, reward);
        ...
        if (_relock) {
            ...
            _transferStakingToken(_withdrawTo, locked);
        }
    }
    ...
    function _transferStakingToken(address _account, uint256 _amount) internal {
        //transfer
