// Welcome to the dawn of $PEPEMAD Token, an innovative and exciting digital asset inspired by Pepe and madness

// Website  : https://pepemad.com
// Twitter  : https://twitter.com/pepemadmad
// Telegram : https://t.me/pepemadmad
// Whitepaper  : https://doc.pepemad.com
...
contract PEPEMAD is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PEPEMAD";
    uint256 private SwapTokens = 10000 * 10**_decimals; 
    uint256 private maxSwapTokens = 300000 * 10**_decimals;
    ...
    uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0xc0c644BEF9800B346102a9653F819F40909dfc40);
