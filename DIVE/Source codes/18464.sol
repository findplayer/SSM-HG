...
contract DropRadar is ERC20, Ownable {
    ...
    constructor() ERC20("DropRadar", "DROP") {
        ...
        // create pair
        lpPair = IUniswapFactory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        ...
        gonSwapThreshold = totalSupply * 1 / 1000;
    ...
    function updateGonSwapThreshold(uint256 newAmount) external onlyOwner {
  	    require(newAmount >= totalSupply() * 1 / 100000, "Swap amount cannot be lower than 0.001% total supply.");
  	    require(newAmount <= totalSupply() * 1 / 1000, "Swap amount cannot be higher than 0.1% total supply.");
  	    gonSwapThreshold = newAmount;
  	}
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        bool canSwap = contractTokenBalance >= gonSwapThreshold;
    ...
    function swapBack() private {
        ...
        if(contractBalance > gonSwapThreshold * 60){
            contractBalance = gonSwapThreshold * 60;
        }
