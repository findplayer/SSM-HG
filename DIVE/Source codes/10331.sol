...
contract BRICSTether is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("BRICS Tether", "BRICST");
        __ERC20Burnable_init();
        __Pausable_init();
        __AccessControl_init();
        __ERC20Permit_init("BRICS Tether");
    ...
    function mint(address to, uint256 amount, bytes32[] memory _merkleProof) public onlyRole(MINTER_ROLE) {
