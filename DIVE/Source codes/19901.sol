...
contract KapturBot is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxWallet = payable(0x0616F4b90890819ffF37c4bb444c9F609b10aC74);
    ...
    string private constant _name = unicode"KapturBot";  // Name
    string private constant _symbol = unicode"KPT"; // Symbol
