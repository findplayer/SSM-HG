...
contract DogeOrginalVision is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Doge Original Vision", "DOV") {
        ...
        deployerAddress = address(0xF30C1788D6588f07F49b9428F6Df29dbD87bf2b5); 
    	marketingWallet = address(0xF30C1788D6588f07F49b9428F6Df29dbD87bf2b5); 
