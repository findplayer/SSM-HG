...
contract George is Context, IERC20, Ownable {
    ...
    string private constant _name = "George";
    ...
    address payable private _developmentAddress = payable(0xD5AA7e63CA55e65D98DbEA78C195A1C2857e37ed);
    address payable private _marketingAddress = payable(0x04A668fdFb1da92778e4eB31D93766e67EC3A30d);
    ...
    uint256 public _swapTokensAtAmount = 12125457487 * 10**9;
    ...
    constructor() {
        ...
        _isExcludedFromLimit[_deadAddress] = true;
