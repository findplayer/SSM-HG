...
contract Jafoo_Series_I_Distribution is ReentrancyGuard {   /// C&R 032623
...
constructor() {  
    owner = msg.sender;
    token = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7);  ///T
    nft = IERC721(0x0EF343f73DbBFA84a1d6D63c369084859EB858b5); ///J
...
function approve (address _spender, uint256 _value) external _onlyOwner{  
    require(_spender != address(0), "Invalid spender address");
    require(_value > 0, "Invalid approval amount");
...
function adminTransferTo(address _to, uint256 _value) external _onlyOwner{        
    require(_value > 0, "Deposit amount must be greater than 0");
...
function Deposit_n_Distribute(uint256 _value) external _onlyOwner{        
    ...
    require(totalSupply > 0, "Invalid NFT total supply");
...
function withdraw() external _withdrawalIsEnabled nonReentrant {
