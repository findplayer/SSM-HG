...
contract LuminaStaking is Ownable,Pausable,ReentrancyGuard{
    ...
    uint256 public minimumDeposit = 1000000000000000000; //1 tokens

    constructor(IBEP20 _token)  {
        Token = _token;
        allocation[360] = 7927448000; 

        // 28 % APY // 0.000000007927448 per sec
