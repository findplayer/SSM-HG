...
abstract contract Project {
    address public marketingWallet = 0xE8632A876F9623BaA761D1af8442Ef3F66Ab99Ab;
    address public devWallet = 0xcC29522cbDaDA42afe8a2142294fE57543E1d50e;

    string constant _name = "Grokality";
    string constant _symbol = "GROKALITY";
 ...
 * MainContract
 */
contract grokalityContract is Project, IERC20, Ownable {
    ...
    uint256 public swapAmount = _totalSupply * 500 / 10000;
