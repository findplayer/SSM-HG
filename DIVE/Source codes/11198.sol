...
contract ZK is Context, IERC20, Ownable { 
    ...
    address payable private _devWallet = payable(0x8487DCb21A4517539432070e2500FA041A5869eA); 

    string private constant _name = "ZK Moon";
    string private constant _symbol = "ZKMOON";
