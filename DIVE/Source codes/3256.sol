...
contract BumbleShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bumble Shiba";
    string private constant _symbol = "Bumble-S";
