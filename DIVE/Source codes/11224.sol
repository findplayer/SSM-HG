...
/// @custom:security-contact cryptomemeboiz@proton.me
contract DeezNuts is ERC20, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("Deez Nuts", "BALLS")
        Ownable(initialOwner)
        ERC20Permit("Deez Nuts")
    {
