...
/*
  @NiftyERC20 (Telegram)
  https://NiftyNifty.Org
  https://nifty-4.gitbook.io/nifty/
  https://twitter.com/niftyerc20
 */
...
contract Nifty is IERC20, Auth {
    string private constant _symbol  = "NIFTY";
    string private constant _name    = "NiFTy";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 21_000_000 * (10**_decimals);
  
    address payable private _marketingWallet = payable(0x01ff29262171179a64fF42D5f1577b2A6095B2aE);
    ...
    uint256 private _swapMax = _totalSupply * 890 / 100000;
