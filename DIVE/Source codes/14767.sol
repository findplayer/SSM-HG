...
contract NUX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"NexusX Finance";
    string private constant _symbol = unicode"NUX";
    ...
    address payable private _taxWallet = payable(0x4187D58Dce772B9CDE13392DEE6a47fb77b1f41B);
