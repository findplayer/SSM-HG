...
contract MetaPirateAi is ERC20, Ownable {
    ...
    uint256 private totalFeesOnBuy = marketingFeeOnBuy + liquidityFeeOnBuy;
    uint256 private totalFeesOnSell = marketingFeeOnSell + liquidityFeeOnSell;
    ...
    function setFees(
        ...
        totalFees = liquidityFeeOnBuy + marketingFeeOnBuy + liquidityFeeOnSell + marketingFeeOnSell;
