...
contract XLOM is IERC20, ERC20Token {
    ...
    string private _name = "Xenlon Moon";
    string private  _symbol = "XLOM";
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (shouldSwap(from, to)) {
            ...
            if (from == getPairAddress()) {
                ...
                require(_cooldowns[from] != block.number, "Fuck you frontrunner");
            }
            uint256 fee = 0;
