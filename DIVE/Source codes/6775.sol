 ...
 */
contract ERC721Staking is ERC20 , Ownable, ReentrancyGuard, Pausable {
    ...
    function setConstrct(IERC721 _nftCollection) external onlyOwner {
     ...
     */
    function stake(uint256[] calldata _tokenIds) external  payable whenNotPaused {
