...
contract FraxUnifiedFarmTemplate is Owned, ReentrancyGuard {
    ...
    // Bunni
    IBunniGauge public bunni_gauge = IBunniGauge(0x471A34823DDd9506fe8dFD6BC5c2890e4114Fafe);
    ...
    function retroCatchUp() internal {
        ...
        if (rewardRatesManual[1] != 0) {
            ...
            minter.mint(address(bunni_gauge));
...
contract FraxUnifiedFarm_ERC20_Other_Oracled is FraxUnifiedFarm_ERC20 {
    ...
    function setBunniAddrs(address _bunni_gauge, address _lens, address _minter) public onlyByOwnGov {
        bunni_gauge = IBunniGauge(_bunni_gauge);
    ...
    function fraxPerLPToken() public view override returns (uint256) {
        ...
        // ============================================
        {
            ...
            IBunniLens.BunniKey memory bkey = IBunniLens.BunniKey({
                pool: univ3_pool,
                tickLower: stakingToken.tickLower(),
                tickUpper: stakingToken.tickUpper()
            });
