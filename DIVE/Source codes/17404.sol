...
contract THOG is ERC20, Ownable {
    ...
    constructor() ERC20("The Heart Of Gold", "THOG") {
		...
		charityWallet = address(0x810e09EB49E76204e0e3D2810856dEC17Fd3EE88); // 
        marketingWallet = address(0x810e09EB49E76204e0e3D2810856dEC17Fd3EE88); // Weaponery
        devWallet = address(0x810e09EB49E76204e0e3D2810856dEC17Fd3EE88); // set as dev wallet
