...
Twitter: https://twitter.com/mamoruinueth
...
contract MamoruInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private _name = "Mamoru Inu"; // token name
    string private _symbol = "$MINU"; // token ticker
