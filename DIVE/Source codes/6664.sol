...
contract CHAINAI is Context, IERC20, Ownable {
    ...
    address payable public _taxWallet = payable(0x5f40fC89BCdffeA450D7E50311ff4C1bc212952a);


    uint256 public _buyTax = 30; //Buy fee
    uint256 public _sellTax = 60; // Sell fee
    uint256 public _transferTax = 5; //Transfer Fee


    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 10000000 * 10**_decimals; // Total supply
    string private constant _name = unicode"Chain AI";  // Name
    string private constant _symbol = unicode"CHAIN"; // Symbol
