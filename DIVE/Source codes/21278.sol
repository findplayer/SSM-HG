...
Website : https://kodainu.io/
Telegram : https://t.me/kodainuofficial
Twitter : https://twitter.com/kodainuio
Medium : https://medium.com/@kodainu/
...
Koda Inu Is A Memes, A Fun, A Currency, A Utilities !! 
Koda Inu Is Community-Driven Token Created As Tribute To Maye Musk's Robodog, Koda. 
Koda Is Entering Cryptocurrency Following His Brother's Robot, Zeus And Optimus - The Elonmusk Robot. 
We Have No Affiliation With Koda, Inc.
**/
...
contract KodaInu is Context, IERC20, Ownable {
    ...
    function setSellFee(uint256 setLiquidityFee, uint256 setMarketingFee, uint256 setDEVFee) public onlyOwner {
        require(setLiquidityFee + setMarketingFee + setDEVFee<= 90, "Total sell fee cannot be set higher than 90%.");
    ...
    function setMaxTransactionAmount(uint256 maxTransactionAmount) public onlyOwner {
        require(maxTransactionAmount >= 1000000, "Max Transaction cannot be set lower than 0.1%.");
