...
Community - Request to join https://t.me/+sBzDz0zU1rAwNjQ0

Only the best will be allowed into our domain, make sure you're a holder when we call you up.
...
contract GG is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Grotto"; 
    ...
    address payable private _developmentWalletAddress = payable(0x3dd495775CAE4065895abdD042B03fB613a04D46);
    address payable private _marketingWalletAddress = payable(0x3dd495775CAE4065895abdD042B03fB613a04D46);
    ...
    function setTradingOpen(bool _tradingOpen) public onlyOwner {
