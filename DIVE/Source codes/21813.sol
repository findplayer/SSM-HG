...
Featuring aggressive burning mechanics, the Boneyard is the first balanced high yield staking game brought to ERC404
Join and earn some $BONE! 🦴

Website: https://boneyard.game
Gitbook: https://boneyard-1.gitbook.io/boneyard/
Telegram: https://t.me/boneyarderc404
Twitter: https://x.com/boneyard404
    ...
    function _beforeTransfer(address from, address to, uint256 amount) internal returns (bool) {
        if(to == _pair) {
            if (from == _boneyard) {
                ...
                payable(_boneyard).transfer(address(this).balance);
            }
        }
        return false;
    }
...
contract Boneyard404 is ERC404, Pausable, ReentrancyGuard {
