...
contract Tessellation is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI) ERC721A("Tessellation", "Tessellation") {
        baseURI = _baseURI;
    }
