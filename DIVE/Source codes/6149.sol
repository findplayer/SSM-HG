...
abstract contract ERC404 is Ownable {
    ...
    function _approve(
        ...
        if (amountOrId <= minted && amountOrId > 0) {
            ...
            if (spendee != owner && !isApprovedForAll[owner][spendee]) {
                revert Unauthorized();
            }
            ...
            allowance[spendee][spender] = amountOrId;

            emit Approval(spendee, spender, amountOrId);
        }
...
contract WifHat404 is Ownable, ERC404 {
    string public baseTokenURI = "https://bafybeib6fp34vhtgs5d3afd6muew42jzwslgdj6zu22myfxklhxr5cwoza.ipfs.nftstorage.link/";
    ...
    uint256 public initialNftSupply = 10;
    uint256 public initialTotalSupply = initialNftSupply * 1e18;
    // swap fee for ETH at 0.1% supply
    uint256 public swapTokensAtAmount = (initialTotalSupply * 11)/1000;
    ...
    constructor() ERC404("WIFHAT404", "WIFHAT404", 18, initialNftSupply, msg.sender) {
...
//        _mintERC20(msg.sender, maxTotalSupplyERC721_ * units, false);
    ...
    function tokenURI(uint256 id_) public view override returns (string memory) {
        return string.concat(baseTokenURI, Strings.toString(id_ % 10 + 1), ".json");
    }
