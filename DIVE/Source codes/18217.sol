...
contract DogeTitter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Doge Titter", "DITTER") {
        ...
        marketingWallet = address(0x76202c2049dF7003a17c55dEc466c9030dcAB9AD);
        developmentWallet = address(0x76202c2049dF7003a17c55dEc466c9030dcAB9AD);
