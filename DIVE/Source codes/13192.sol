...
// https://bardy-protocol.com
// http://t.me/bardy_protocol
...
// Main Contract Logic 
// --------------------------------------------------------------
contract Bardy  is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Bardy Protocol";
    string private _symbol = "BARDY";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x03d25a71c70A20a881980F23Dd7D7Eeeb435a2Fd);
    address payable public operationsWallet =  payable(0x03d25a71c70A20a881980F23Dd7D7Eeeb435a2Fd);
