...
contract Safemoon is ISafemoon, Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address bridgeBurn) public initializer {
        __Context_init_unchained();
        __Ownable_init_unchained();
        __Safemoon_v2_init_unchained(bridgeBurn);
    }

    function __Safemoon_v2_init_unchained(address bridgeBurn) internal initializer {
        _name = "SafeMoon";
        _symbol = "SFM";
        _decimals = 9;
