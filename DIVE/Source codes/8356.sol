...
contract staking {
    ...
    uint256[5] public Duration = [30 days, 60 days, 90 days, 120 days, 150 days];
    uint256[5] public Bonus = [12, 26, 40, 0, 0];
    ...
    function stake(uint256 amount, uint256 timeperiod) public {
        ...
        uint256 ETFVAL = getPriceinUSD();
        uint256 rewardtokenPrice = (amount.mul(ETFVAL)).div(1e9);
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address ETF_WETH = 0x558a9b341a7c350276bE4E07A9766061fFe7b51C;
        
        IERC20 ETFTOKEN = IERC20(0x790Ed3c45898cA647080859e6863869aFed4C8F8);
        IERC20 WETHTOKEN = IERC20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
        
        uint256 ETFSUPPLYINETF_WETH = ETFTOKEN.balanceOf(ETF_WETH);
        uint256 WETHSUPPLYINETF_WETH = WETHTOKEN.balanceOf(ETF_WETH);
        
        uint256 ETHPRICE = (ETFSUPPLYINETF_WETH.mul(1e18)).div(WETHSUPPLYINETF_WETH);

        uint256 ETFUSDVAL = (((WETHSUPPLYINETF_WETH.mul(1e9)).div((ETFSUPPLYINETF_WETH))).mul(ETHPRICE)).div(1e18);
        return ETFUSDVAL;
    }
