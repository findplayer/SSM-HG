...
pragma solidity ^0.8.4;
    ...
    contract TestRun is ERC721A, Ownable {
    ...
    string public NR = "ipfs://HIDDEN_DATA/";
    ...
    constructor() ERC721A("TestRun", "TESTRUN")
    {
        validator = owner();
    }
