...
// File contracts/interfaces/ICraftsmanV2.sol
...
/** 
 * @title ICraftsmanV2
 * @notice It is an interface for CraftsmanV2.sol
 */
...
contract Rewarder is OwnableUpgradeable, UUPSUpgradeable {
    ...
    ERC20Upgradeable public immutable rewardToken;

    ICraftsmanV2 public immutable craftsmanV2;

    uint256 public immutable ACC_TOKEN_PRECISION; // precision factor
    ...
    function pendingToken(uint256 _pid, address _user) public view returns (address, uint256) {
        ...
        uint256 lpSupply = ERC20Upgradeable(craftsmanV2.poolInfo(_pid)).balanceOf(address(craftsmanV2));
    ...
    /// @dev if a pool has been added, we cannot set _rewardStartTimestamp to be earlier 
