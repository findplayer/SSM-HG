...
contract Yup is ISJ741 {

    string public baseURI = "";
    string internal constant _name = "SJ741 Yup";
    string internal constant _symbol = "YUP";
    ...
    function tokenURI(uint256 tokenId) public view virtual returns (string memory) {
        string memory metadata = '{"description": "ERC741 is ERC20 + ERC721 and functions both in Uniswap, and Opensea.","image": "https://shdw-drive.genesysgo.net/BXWvwctbRwDi3S15sWJmgJ6WutrkYzQGrv3vDdpCMtyD/7x2h5fpt.jpg","name": "Big Yup","attributes": []}';
