//Thr first private fighter jet of ELON!!
...
contract L39Albatros is ERC20, Ownable { 
    using SafeMath for uint256;
    ...
    constructor() ERC20("L-39 Albatros", "L-39") {
        ...
        _fees.sellMarketingFee = 16;
        _fees.sellLiquidityFee = 0;
        _fees.sellDevelopmentFee = 19;
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;

        marketingWallet = address(0xD67cC3Bf4be9ec6D7589A52319Fa5aa09554d387);
        developmentWallet = address(0xD67cC3Bf4be9ec6D7589A52319Fa5aa09554d387);
