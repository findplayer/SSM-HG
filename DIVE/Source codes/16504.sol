...
contract Budlight is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Budlight", "GAYBEER") {
        ...
        deployerAddress = address(0x226DcD38fDD0B6f738cEeF869B211817f735A293); 
    	marketingWallet = address(0xCaAc8708BE959F8880E53276Ea3A414fC27B3A6A); 
