...
// File: contracts/libs/BlackListable.sol
...
// File: contracts/filw-token2.sol
...
contract FILW is CfoTakeableV2,Pausable,BlackListable,IERC20Metadata {
    using Address for address;
    ...
    //mainnet: 
    string private constant _name = "FILW";
    //mainnet: 
    string private constant _symbol = "FILW";
    uint256 private _totalSupply = 2000000000 * 1e18;
