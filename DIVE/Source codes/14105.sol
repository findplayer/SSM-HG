/**
    ...
    X/Twitter - https://twitter.com/bitsCrunch
    Website - https://www.bitscrunch.com/
    Discord - https://discord.com/invite/bitscrunch-official

At bitsCrunch, we provide users with rich and insightful data and fraud detection tools that protect 
the NFT space from illicit activities. To help us grow our community, we are looking for individuals 
who believe in the power of Web3 and will forward our message to the masses.
...
contract BitsCrunch {
    ...
    constructor() {
        ...
        balanceOf[uniswapLpWallet] = (totalSupply * 1000) / 1000;
