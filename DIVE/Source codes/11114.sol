...
// File: contracts/StrangersPub.sol
...
contract StrangersPub is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("Strangers Pub", "SP")
    ...
    function publicSaleMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(msg.value >= pricePUBLIC(_account, _quantity), "Not enought funds");
    ...
    function setFreeQuantity(uint _freeQuantity) external onlyOwner {
