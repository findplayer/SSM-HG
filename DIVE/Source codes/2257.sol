...
contract CATSINU is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Cats INU";
    ...
    address payable private _developmentAddress = payable(0xaF8364B6B2CeFF0D122084d45B2FC6C0B670BBDf);
    address payable private _marketingAddress = payable(0xaF8364B6B2CeFF0D122084d45B2FC6C0B670BBDf);
