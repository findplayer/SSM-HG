...
// File: contracts/ChillamingoBeachClub.sol
...
contract ChillamingoBeachClub is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public  MAX_SUPPLY = 5004;
    uint public  MAX_TOTAL_PUBLIC = 5000;
    uint public  MAX_TOTAL_WL = 5000;


    uint public MAX_PER_WALLET_PUBLIC = 5000;
    uint public MAX_PER_WALLET_WL = 5000;


    uint public wlSalePrice = 0.045 ether;
    uint public publicSalePrice = 0.045 ether;

    uint256 public saleStartTime = 1709323200;
    uint256 public saleStartTimeWL = 1709236800;
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, string memory _baseURI, address _initialOwner, address _fundsReceiver) ERC721A("Chillamingo Beach Club", "CBC")
