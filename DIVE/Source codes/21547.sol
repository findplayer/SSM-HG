...
contract A8 is Context, Ownable, IERC20, ERC20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0xE788c6A58ee189ef0c3819D9e4A672f2655cd9D3);
  
    bool inSwapAndLiquify;
    bool private swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToFee = 50000 * 10**18;
    ...
    constructor () ERC20Detailed("AccelDAO", "A8", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 10000 * 10**18 && _numTokensSellToFee <= 500000 * 10**18, "Threshold must be set within 10,000 to 500,000 tokens");
