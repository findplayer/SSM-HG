    ...
    DefaultOperatorFilterer
{
    ...
    //
    // Minting Variables
    uint256 public mintPrice = 420 ether;
    ...
    function DepositMETL(uint256 amount) public {
        ...
        METLTokenAddress.approve(address(this), amount);
    ...
    function MintTitan(
        ...
        // Are we allowed to mint?
        require(saleIsActive, "Sale not active!");

        // Transfer METL
        DepositMETL(mintPrice);
        ...
        mythicArtifacts.burnArtifacts(msg.sender, artifactId, 1);
    ...
    function SendNFTToDead(address nftContractAddress, uint256 tokenId) public {
        ...
        // Check if the BurnTheNFTs contract is approved to manage the NFT
        ...
        nftContract.safeTransferFrom(tokenOwner, DEAD, tokenId);
    }
