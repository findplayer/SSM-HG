...
contract TPUAi is ERC20, Ownable {
    ...
    address public marketingWallet = address(0x24782977C131Bd2B355Db2af263eaA0AC869A7ed);
    /// @notice development wallet address
    address public developmentWallet = address(0x6ef04Ca42D964C9eFA6E9A12279D5596631AC7b8);
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        if (marketingEth > 0) {
            bool sent;
            (sent, ) = marketingWallet.call{value: marketingEth}("");
        }
