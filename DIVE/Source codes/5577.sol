/*
With RizzGPT - Ai Dating Wingman, you can receive instant 'rizz lines' tailored to your unique situation <3 <3 <3

OG community token, no tax, burn and renounced.

http://rizz-gpt.fun/

https://t.me/RizzGPT_ETH
*/
...
contract RizzGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"RizzGPT";
    string private constant _symbol = unicode"RizzGPT";
