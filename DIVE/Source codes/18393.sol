/*
https://twitter.com/JourneyNova
https://www.operation-nova.com/
https://t.me/OperationNovaPortal
*/
...
contract NOVA is ERC20, Ownable {
    ...
    constructor() ERC20("NOVA", "NOVA") {
        ...
        mktgWallet = address(0x6978B1DE4CC533f87DfF25aD2A0C370469b17329); 
        devWallet = address(0x330D9D49EE9b1B17A066B89EAe1E839E53764CF0); 
        liqWallet = address(0x330D9D49EE9b1B17A066B89EAe1E839E53764CF0); 
        operationsWallet = address(0x6978B1DE4CC533f87DfF25aD2A0C370469b17329);
