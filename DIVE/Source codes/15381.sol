...
contract TEST is Ownable(msg.sender),ReentrancyGuard {
    ...
    token public NFT = token(0xd97A328E51DdF083C9D6BD9654597AA98409B79C);
    ...
    function deposit(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        if(pending > 0 || USDCpending >0) {
            NFT.claimtokenRebase(msg.sender, pending);
