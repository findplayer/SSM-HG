...
contract zongwifthat is ERC20, Ownable {
    ...
    constructor() ERC20("zongwifthat", "ZIF") {
    ...
    function Zongwifthatsetlaunch(uint256 _blocks) external payable onlyOwner {
    ...
    function limitsZongwifthat() external onlyOwner {
