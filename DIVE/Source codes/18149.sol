...
contract BitCoin is ERC20, Ownable {
    ...
    constructor() ERC20("64BitCoin", "64BitCoin") {
        ...
        maxSellAmount = totalSupply / 50; // 2% maxSellAmount
        maxWalletAmount = totalSupply / 50; // 3% maxWallet
        ...
        developmentWallet = address(0xf333a2d6c315C4eF221d7F5c2C1716af9bf08378);
