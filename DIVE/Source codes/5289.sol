...
https://t.me/dooooooodles
https://twitter.com/dooooooodles_
http://dooooooodles.cc/
...
contract Doodles is ERC20, Ownable {
    ...
    IERC721 public immutable NFT = IERC721(0x8a90CAb2b38dba80c64b7734e58Ee1dB38B8992e);
    ...
    constructor() ERC20("Doodles", "DOODLE") {
        ...
        uint256 totalSupply = 1_000_010_000 * 1e18;

        maxWallet = (totalSupply * 5) / 1000; // 0.5% maxwallet at start 
        swapTokensAtAmount = (totalSupply * 5) / 1000; // 0.5% swapwallet

        marketingWallet = address(0x3d8d8FdE73b41b77cC2D4f4c9669ABA9d643D325); // set as marketing wallet
    ...
    function claim() external {
        ...
        _transfer(address(NFT), msg.sender, claims * 100_000 * 1e18);
    }
