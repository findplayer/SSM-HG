/**
 _______  ______   _______     ______   ______  _______  _______ 
...
(_______/(______/ (_______/   \_____/  \_____/ (_______)(_______)

---> This project is a homage to the first super computer developed by Control Data Corporation.
---> https://cdc6600.ai/
*/
...
contract CDC6600 is Context, IERC20, Ownable {
    ...
    string private _name = "CDC6600";
    string private _symbol = "CDC6600";
    ...
    uint256 public defaultMarketingFee = 35;
    ...
    address payable public marketingWallet = payable(0xB7F83ad82f3517Dc6A20dd4993AcaaA8e3655315);
