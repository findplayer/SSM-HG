...
contract MESSENGER is ERCX {
    ...
    string private constant _ticker = "MESSENGER";
    ...
    constructor() ERCX("", _name, _ticker, _decimals, _totalTokens, _tokensPerNFT) {
        dataURI = "https://bafybeib7idccguyh6sng3yzxerlooy6azskkgjxopzpqihwg4yxxgboj3y.ipfs.nftstorage.link/";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            if (seed <= 63) {
                image = "Seraphim.gif";
                color = "Seraphim";
                description = "Seraphim NFTs, meticulously mined by industry elites and crafted with unparalleled precision, symbolize the pinnacle of luxury and digital artistry. Join us on Messenger to embark on an interstellar journey, where we explore the boundless universe aboard our spacefaring vessels.";
            } else if (seed <= 127) {
                image = "Cherubim.gif";
                color = "Cherubim";
                description = "Cherubim NFTs, carefully mined by expert collectors and meticulously crafted with golden excellence, symbolize the pinnacle of digital rarity and exclusivity. Join us on Messenger to embark on an interstellar journey, where we explore the boundless universe aboard our spacefaring vessels.";
            } else if (seed <= 191) {
                image = "Ophanim.gif";
                color = "Ophanim";
                description = "Ophanim NFTs, meticulously excavated by seasoned collectors and crafted with unparalleled precision, epitomize the peak of digital rarity and exclusivity. Join us on Messenger to embark on an interstellar odyssey, as we traverse the limitless cosmos aboard our spacefaring vessels.";
            } else if (seed <= 255) {
                image = "Dominions.gif";
                color = "Dominions";
                description = "Dominions NFTs, diligently curated by expert collectors and crafted with utmost precision, represent the epitome of digital rarity and exclusivity. Join us on Messenger to embark on an interstellar adventure, where we explore the endless cosmos aboard our spacefaring vessels.";
            }

            string memory jsonPreImage = string(abi.encodePacked('{"name": "MESSENGER #', id.toString(), '","description":"', description, '","external_url":"https://twitter.com/Messenger_ERCX","image":"', dataURI, image));
