...
Website: https://tofuinu.xyz
Telegram: https://t.me/tofuinuportal
Twitter: https://twitter.com/tofu_inu_
...
contract TofuInu is IERC20, Ownable { 
    string private constant _name = "Tofu Inu"; 
    ...
    uint256 public constant maxWalletAmount = 2_000_000_000 * 10**_decimals; //xxx Max Hold
    uint256 private constant contractSwapLimit = 2_000_000_000 * 10**_decimals;
    uint256 private constant contractSwapMax = 2_000_000_000 * 10**_decimals;
    ...
    address payable private constant Treasury = payable(0xd726025dca3AAd47cB6aCAB3F8B6eBC849043E78);
