...
|  $$$$$$ |_  $$_/   |____  $$ /$$__  $$| $$  /$$/| $$__  $$ /$$__  $$|_  $$_/  
 ...
 /$$  \ $$  | $$ /$$ /$$__  $$| $$      | $$_  $$ | $$  | $$| $$_____/  | $$ /$$
|  $$$$$$/  |  $$$$/|  $$$$$$$| $$      | $$ \  $$| $$  | $$|  $$$$$$$  |  $$$$/
 \______/    \___/   \_______/|__/      |__/  \__/|__/  |__/ \_______/   \___/  
...
contract Starknet is ERC20, Ownable {
    ...
    constructor(address _owner, address _marketAddr) ERC20("Starknet Token", "STRK") Ownable(_owner) {
        _mint(owner, 1000000000*10**18);
        nft = SendMarket(_marketAddr);
    }

    // Burn STRK from caller

    function burn(uint256 amount) external {
        _burn(_msgSender(), amount);
    }

    // Burn STRK from account with approval
