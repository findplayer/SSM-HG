...
contract BlurDepositor{
    ...
    constructor(address _staker, address _minter, address _blur) public {
        staker = _staker;
        minter = _minter;
        blur = _blur;
    }
    ...
    function deposit(uint256 _amount, address _stakeAddress) public {
        ...
        IERC20(blur).safeTransferFrom(msg.sender, staker, _amount);
    ...
    function depositAll( address _stakeAddress) external{
        uint256 crvBal = IERC20(blur).balanceOf(msg.sender);
