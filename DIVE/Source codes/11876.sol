...
Website:   https://takarta.gg

Docs:      https://docs.takarta.gg
...
contract Takarta is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Takarta";
    string private constant _symbol = unicode"TKT";
    ...
    function sendETHToFee(uint256 amount) private {
     ...
     function clearStuckBalance(uint256 amountPercentage) external onlyOwner() {
        ...
        payable(_taxWallet).transfer(amountETH * amountPercentage / 100);
    }
