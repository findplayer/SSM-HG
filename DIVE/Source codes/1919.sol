...
contract FraxUnifiedFarm_ERC20 is FraxUnifiedFarmTemplate {
    ...
    // Bunni
    IBunniTokenLP public stakingToken;
...
// File contracts/Staking/Variants/FraxUnifiedFarm_ERC20_Other_Oracle.sol





contract FraxUnifiedFarm_ERC20_Other_Oracle is FraxUnifiedFarm_ERC20 {
    ...
    FraxUnifiedFarm_ERC20(_owner , _rewardTokens, _rewardManagers, _rewardRates, _gaugeControllers, _rewardDistributors, _stakingToken)
    {
        ...
        // Bunni
        stakingToken = IBunniTokenLP(_stakingToken);
        univ3_pool = IUniswapV3Pool(stakingToken.pool());
    ...
    function fraxPerLPToken() public view override returns (uint256) {
        ...
        // ============================================
        {
            ...
            uint256 frxETH_in_pool = IERC20(0x5E8422345238F34275888049021821E8E08CAa1f).balanceOf(address(univ3_pool));
            uint256 frxETH_usd_val_per_lp_e8 = (frxETH_in_pool * uint256(getLatestETHPriceE8())) / univ3_pool.liquidity();
