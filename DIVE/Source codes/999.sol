...
contract brETHVault is ERC20, Ownable(msg.sender), ReentrancyGuard {
    ...
    function mint() external payable nonReentrant{
        ...
        // Assuming the contract can hold and manage ETH directly for fees
        payable(buybackWallet).transfer(fee);
    }
    ...
    function checkProtocolProfits() public view returns (uint256) {
        uint256 totalStETH = address(this).balance; // This should be the balance of stETH instead
