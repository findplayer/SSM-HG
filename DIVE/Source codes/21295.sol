...
// Telegram - https://t.me/tombstonetoken
// Website - https://tombstone.dev
...
contract RIP is Ownable, ERC20 {
    ...
    string constant _name = "Tombstone";
    string constant _symbol = "RIP";
    uint8 constant _decimals = 18; 

    uint256 _totalSupply = 1 * 66**6 * 10**_decimals;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x23D1594FDF6a6a02A2501b9524b3787A088430aE;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        function setMaximumWalletPercent(uint256 maxWallPercent) public {
        require(_maxWalletToken >= _totalSupply / 1000); //no less than .1%
        _maxWalletToken = (_totalSupply * maxWallPercent ) / 100;
                
    }

    function SetMaximumTxPercent(uint256 maxTXPercent) public {
        require(_maxTxAmount >= _totalSupply / 1000); //anti honeypot no less than .1%
        _maxTxAmount = (_totalSupply * maxTXPercent ) / 1000;
    }

    
    function setTxLimitMaximum(uint256 amount) external onlyOwner {
    ...
    function setTargetMultipliers(uint256 _buy, uint256 _sell, uint256 _trans) external onlyOwner {
    ...
    function UpdateMinimumGas (uint256 _MinGas) public onlyOwner {
    ...
    function setIsFeeExempted(address holder, bool exempt) external onlyOwner {
        isFeeExempt[holder] = exempt;
    }

    function setIsTxLimitExempted(address holder, bool exempt) external onlyOwner {
    ...
    function setTrgtLiquidity(uint256 _target, uint256 _denominator) external onlyOwner {
