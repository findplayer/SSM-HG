...
//Ye stupid! Don't buy dis sh*t
//Twitter: @AprilFirstERC20
//Telegram: Too Lazy to Create (-_-)
...
contract AprilFirst is ERC20, Ownable {
    ...
    constructor() ERC20("April First", "FOOLS") {
        ...
        uint256 totalSupply = 411582 * 1e18;

        maxTransactionAmount = 411582 * 1e18;
        maxWallet = 411582 * 1e18;
        ...
        marketingWallet = address(0xaE03d23a0b751D83cb55a816133899c05acB06Ee);
