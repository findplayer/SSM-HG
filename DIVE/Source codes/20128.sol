...
contract Poon is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Pepe Moon";
    string private constant _symbol = "Poon";
    ...
    uint256 public _swapTokensAtAmount = 2000000 * 10**_decimals;
    ...
    constructor(address developmentAddr, address marketingAddr, address devFeeAddr1, address devFeeAddr2) {
        ...
        distribution = Distribution(33, 34, 33);
