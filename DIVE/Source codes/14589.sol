...
contract PepeCEO is IERC20, Auth {
    ...
    address payable public marketingWallet = payable(0x357fe418d2bcAA485d3A7cAe454aC2d37Ae16fab);
    ...
    uint256 private maxBuyTransaction = ( _totalSupply * 20 ) / 1000; // 2% max tx
